...
type
  ...
  public
    ...
    function CountNumberOfMoreExpensiveBooks: integer;
...
function TBookProxy.CountNumberOfMoreExpensiveBooks: integer;
var
...
begin
  ...
  self.ForEach(
    ...
    begin
      if (dsp as TBookProxy).Price.Value > CurrentPrice then
        Count := Count + 1;
    end);
  Result := Count;
end;
...
begin
  // Result := Authors.Value + ' - ' + Title.Value;
  Result := Price.AsString + ' - ' + Title.Value;
end;
